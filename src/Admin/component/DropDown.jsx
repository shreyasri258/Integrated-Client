    ...
    <div className="flex">
      <div className="relative">
        <button
          ...
          className="bg-blue-500 text-white p-2 w-52 rounded-md hover:bg-blue-600 text-sm"
        >
        ...
        >
          {options.map((option, idx) => {
            return (
              <span
                className="p-2 hover:bg-blue-400 hover:text-white cursor-pointer text-sm"
                key={idx}
                onClick={() => {
      ...
      <span className="self-center ml-6 text-base border-b-2 border-blue-600">
        {options[ans] || (
          <span className="italic text-slate-500">Empty Option</span>
        )}
      </span>
